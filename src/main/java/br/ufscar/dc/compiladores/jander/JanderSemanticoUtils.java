...
public class JanderSemanticoUtils {
    ...
    public static boolean compatibilidade(TabelaDeSimbolos tabela, 
        ...
        // REAL pode receber INTEIRO
        if (tipo1 == TabelaDeSimbolos.TipoJander.REAL && 
            tipo2 == TabelaDeSimbolos.TipoJander.INTEIRO||
            tipo1 == TabelaDeSimbolos.TipoJander.INTEIRO && 
            tipo2 == TabelaDeSimbolos.TipoJander.REAL) {
            return true;
        }
        return false;
    }
    ...
    for (var fator : ctx.fator()) {
        ...
        if (tipo == null) {
            ...
            adicionarErroSemantico(ctx.start, "termo contem tipos incompativeis");
            tipo = TabelaDeSimbolos.TipoJander.INVALIDO;
        }
    }
    return tipo;
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela, 
        ...
        if (ctx.op_relacional() != null) {
            ...
            if (!compatibilidade(tabela, tipo, aux)) {
                adicionarErroSemantico(ctx.start, "expressao relacional contem tipos incompativeis");
                return TabelaDeSimbolos.TipoJander.INVALIDO;
            }
        }
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela, 
        ...
        for (var fator : ctx.fator_logico()) {
            ...
            if (tipo == null) {
                ...
                adicionarErroSemantico(ctx.start, "termo logico contem tipos incompativeis");
                tipo = TabelaDeSimbolos.TipoJander.INVALIDO;
            }
        }
        return tipo;
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela, 
        ...
        for (var termo : ctx.termo_logico()) {
            ...
            if (tipo == null) {
                ...
                adicionarErroSemantico(ctx.start, "expressao contem tipos incompativeis");
                tipo = TabelaDeSimbolos.TipoJander.INVALIDO;
            }
        }
        return tipo;
    ...
    public static TabelaDeSimbolos.TipoJander verificarTipo(TabelaDeSimbolos tabela, 
                                                          JanderParser.CmdAtribuicaoContext ctx) {
        ...
        if (!compatibilidade(tabela, tipoVar, tipoExpr)) {
            adicionarErroSemantico(ctx.identificador().start, 
                "atribuicao nao compativel para " + nomeVar + " (" + tipoVar + " <- " + tipoExpr + ")");
        }
